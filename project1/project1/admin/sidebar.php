...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #1977CC;">
    <!-- Brand Logo -->
    <a href="index3.html" class="brand-link">
        <img src="dist/img/images.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">Puskesmas Surken</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">Kelvin Sutirta Wanderer</a>
            </div>
        </div>
