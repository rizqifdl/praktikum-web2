                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="periksa/form_periksa.php"><button class="btn btn-primary mb-1">Tambah Data</button></a>
                                <table class="table table-head-fixed table-responsive-lg table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($query as $row) {
                                            ...
                                            echo "<td>
                                            <a href='periksa/view_periksa.php?id=" . $row['id'] . "' class='btn btn-secondary btn-sm mr-2 mb-2'>View</a>
                                            <a href='periksa/update_periksa.php?id=" . $row['id'] . "' class='btn btn-warning btn-sm mr-2 mb-2'>Update</a>
                                            <a href='periksa/delete_periksa.php?id=" . $row['id'] . "'  class='btn btn-danger btn-sm mb-2' onclick='return confirmDelete()' >Delete</a>
                                            </td>";
                                            echo "</tr>";
                                        }
                                        ?>
